...
export function HomeFinalCta({
  ...
  eyebrow = 'Tu consulta, en pocos pasos',
  title = 'Encontrá lo que necesitás y armá tu consulta',
  description = 'Sumá productos a tu lista y envianos todo junto por WhatsApp.',
  productsLabel = 'Explorar productos',
  inquiryLabel = 'Ver mi consulta',
}: HomeFinalCtaProps) {
  return (
    <section
